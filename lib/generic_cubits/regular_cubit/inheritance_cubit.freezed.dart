...
mixin _$InheritanceState<E, S> {
  ...
  @JsonKey(ignore: true)
  $InheritanceStateCopyWith<E, S, InheritanceState<E, S>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $InheritanceStateCopyWith<E, S, $Res> {
  factory $InheritanceStateCopyWith(InheritanceState<E, S> value,
          $Res Function(InheritanceState<E, S>) then) =
      _$InheritanceStateCopyWithImpl<E, S, $Res, InheritanceState<E, S>>;
  @useResult
  $Res call({RequestState state});
}

/// @nodoc
class _$InheritanceStateCopyWithImpl<E, S, $Res,
        $Val extends InheritanceState<E, S>>
    implements $InheritanceStateCopyWith<E, S, $Res> {
  _$InheritanceStateCopyWithImpl(this._value, this._then);
...
class __$$LoadingImplCopyWithImpl<E, S, $Res>
    extends _$InheritanceStateCopyWithImpl<E, S, $Res, _$LoadingImpl<E, S>>
...
class _$LoadingImpl<E, S> implements _Loading<E, S> {
  ...
  @override
  String toString() {
    return 'InheritanceState<$E, $S>.loading(state: $state)';
  }
...
abstract class _Loading<E, S> implements InheritanceState<E, S> {
...
class __$$errorImplCopyWithImpl<E, S, $Res>
    extends _$InheritanceStateCopyWithImpl<E, S, $Res, _$errorImpl<E, S>>
...
class _$errorImpl<E, S> implements _error<E, S> {
  ...
  @override
  String toString() {
    return 'InheritanceState<$E, $S>.error(state: $state, list: $list)';
  }
...
abstract class _error<E, S> implements InheritanceState<E, S> {
...
class __$$SuccessImplCopyWithImpl<E, S, $Res>
    extends _$InheritanceStateCopyWithImpl<E, S, $Res, _$SuccessImpl<E, S>>
...
class _$SuccessImpl<E, S> implements _Success<E, S> {
  ...
  @override
  String toString() {
    return 'InheritanceState<$E, $S>.success(state: $state, sent: $sent)';
  }
...
abstract class _Success<E, S> implements InheritanceState<E, S> {
